    ...
    <footer className="bg-foreground text-background/70">
      <div className="container mx-auto px-4 py-16">
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div className="space-y-4 lg:col-span-1">
            <div className="flex items-center gap-2">
              ...
              <span className="font-display text-xl font-semibold text-background">Sun Dental - Dr. Ashish Ranjan</span>
            </div>
        ...
        <div className="border-t border-background/10 mt-12 pt-8 text-center text-sm">
          <p>Copyright 2026 Sun Dental - Dr. Ashish Ranjan. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
