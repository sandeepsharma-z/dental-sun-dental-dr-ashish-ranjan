    ...
    <div className="dental-gradient">
      <div className="container mx-auto px-4 flex flex-col sm:flex-row items-center justify-between py-2 text-sm text-primary-foreground gap-2">
        <div className="flex items-center gap-4 md:gap-6 flex-wrap justify-center">
          <a href="tel:09811828767" className="flex items-center gap-1.5 hover:opacity-80 transition-opacity">
            <Phone size={14} />
            <span>098118 28767</span>
          </a>
          <a href="mailto:contact@sundentaldrashish.com" className="flex items-center gap-1.5 hover:opacity-80 transition-opacity">
            <Mail size={14} />
            <span>contact@sundentaldrashish.com</span>
          </a>
